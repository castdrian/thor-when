...
Thanks for helping make the wait a little clearer.
...
Describe what changed, why it helps, and how it was verified. User-facing strings should remain lowercase `thor when?` branding. Keep the visual system accessible in high-contrast, reduced-motion, keyboard, and mobile contexts.
